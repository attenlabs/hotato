...
- **One-fetch context** &middot; [`llms.txt`](https://raw.githubusercontent.com/attenlabs/hotato/main/llms.txt) indexes every command; [`llms-full.txt`](https://raw.githubusercontent.com/attenlabs/hotato/main/llms-full.txt) is the whole doc set in a single file; [`AGENTS.md`](https://github.com/attenlabs/hotato/blob/main/AGENTS.md) and [`docs/MCP.md`](https://github.com/attenlabs/hotato/blob/main/docs/MCP.md) carry the tool contract, the `hotato describe --format json` manifest, and copy-paste client configs (Claude Desktop, Cursor, Codex CLI).
...
The bundled reference agent runs a full offline, byte-reproducible battery across jobs, caller behaviours, and audio environments: `make reference` ([`examples/reference-agent/`](https://github.com/attenlabs/hotato/blob/main/examples/reference-agent/README.md), [`docs/SUITE-RUN.md`](https://github.com/attenlabs/hotato/blob/main/docs/SUITE-RUN.md)); measurement-error harness [`docs/BENCHMARK.md`](https://github.com/attenlabs/hotato/blob/main/docs/BENCHMARK.md).
...
- **Typed Python SDK** (frozen dataclasses over the CLI JSON): [`docs/SDK.md`](https://github.com/attenlabs/hotato/blob/main/docs/SDK.md)
...
- **Recorded-call battery**: [`corpus/vapi-defaults/README.md`](https://github.com/attenlabs/hotato/blob/main/corpus/vapi-defaults/README.md)
